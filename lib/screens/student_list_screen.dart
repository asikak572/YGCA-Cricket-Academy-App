...
class _StudentListScreenState extends State<StudentListScreen> {
            ...
            return AlertDialog(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _approvalInfoTile(
                        isDark,
                        AppStrings.parent,
                        data['parentName']?.toString() ?? AppStrings.notAdded,
                      ),
                      _approvalInfoTile(
                        isDark,
                        AppStrings.parentEmail,
                        data['parentEmail']?.toString() ?? AppStrings.notAdded,
                      ),
                      _approvalInfoTile(
                        isDark,
                        AppStrings.phone,
                        data['phone']?.toString() ?? AppStrings.notAdded,
                      ),
                      ...
                      Container(
                        ...
                        child: Text(
                          AppStrings.rollNoAutoGenerated,
                          style: TextStyle(
              ...
              actions: [
                ...
                ElevatedButton.icon(
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            await FirebaseFirestore.instance
                              ...
                              'feeStatus': data['feeStatus'] ?? AppStrings.pending,
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  AppStrings.studentApprovedParentLinked,
                                ),
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text("${AppStrings.approvalFailed}: $e"),
                  ...
                  label: Text(
                    isSaving ? AppStrings.saving : AppStrings.approve,
  ...
  Future<void> _rejectStudent({
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text(
            AppStrings.rejectStudentQuestion,
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900),
          ),
          content: Text(
            AppStrings.rejectStudentMessage,
            style: TextStyle(fontSize: 13),
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(dialogContext, false),
              child: Text(AppStrings.cancel, style: TextStyle(fontSize: 12)),
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.red,
              ...
              child: Text(AppStrings.reject, style: TextStyle(fontSize: 12)),
            ),
          ],
        );
      },
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppStrings.studentRejected),
          backgroundColor: Colors.red,
        ),
      );
    } catch (e) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("${AppStrings.rejectFailed}: $e"),
          backgroundColor: Colors.red,
        ),
      );
    }
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: GridView.count(
                          ...
                          children: [
                            _statCard(
                              ...
                              title: AppStrings.registered.toUpperCase(),
                              value: allStudents.length.toString(),
                              subtitle: AppStrings.students,
                              color: Colors.blueAccent,
                            ),
                            _statCard(
                              isDark: isDark,
                              icon: Icons.verified_rounded,
                              title: AppStrings.approved.toUpperCase(),
                              value: approvedStudents.length.toString(),
                              subtitle: AppStrings.activePlayers,
                              color: Colors.green,
                            ),
                            _statCard(
                              isDark: isDark,
                      ...
                      _sectionTitle(
                        isDark: isDark,
                        title: AppStrings.searchStudent,
                      ...
                      Padding(
                        ...
                        child: pendingStudents.isEmpty
                            ? _emptyCard(
                                ...
                                title: AppStrings.noPendingApprovals,
                                subtitle:
                                    AppStrings.newStudentsAppearForApproval,
                              )
                            : Column(
                                children: pendingStudents.map((doc) {
                                  ...
                                  return _pendingStudentCard(
                                    ...
                                    isDark: isDark,
                                    doc: doc,
                                    name: data['name']?.toString() ?? AppStrings.noName,
                      ...
                      _sectionTitle(
                        isDark: isDark,
                        title: AppStrings.approvedStudents,
                      ...
                      Padding(
                        ...
                        child: approvedStudents.isEmpty
                            ? _emptyCard(
                                ...
                                title: AppStrings.noApprovedStudentsFound,
                                subtitle:
                                    AppStrings.approvedStudentsAppearHere,
                              )
                            : Column(
                                children: approvedStudents.map((doc) {
                                  ...
                                  final batch =
                                      data['batch']?.toString() ?? AppStrings.noBatch;
                                  final phone =
                                      data['phone']?.toString() ?? '';
                                  final parentName =
                                      data['parentName']?.toString() ??
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppStrings.approvalStudentManagement,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                    color: _secondaryText(isDark),
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            AppStrings.approval.toUpperCase(),
                            style: TextStyle(
                              color: gold,
                          ...
                          Wrap(
                            ...
                            runSpacing: 6,
                            children: [
                              _heroChip("${AppStrings.registered}: $totalStudents"),
                              _heroChip("${AppStrings.approved}: $activeStudents"),
                              _heroChip("${AppStrings.pending}: $pendingApprovals"),
                            ],
                          ),
                        ],
                      ),
  ...
  Widget _pendingStudentCard({
    ...
    String dateText = AppStrings.recently;
