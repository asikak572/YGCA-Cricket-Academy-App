...
class CoachScheduleModuleScreen extends StatefulWidget {
  const CoachScheduleModuleScreen({super.key});

  @override
  State<CoachScheduleModuleScreen> createState() =>
      _CoachScheduleModuleScreenState();
}

class _CoachScheduleModuleScreenState extends State<CoachScheduleModuleScreen> {
  int _currentIndex = 0;
