...
class CoachStudentModuleScreen extends StatefulWidget {
  const CoachStudentModuleScreen({super.key});

  @override
  State<CoachStudentModuleScreen> createState() =>
      _CoachStudentModuleScreenState();
}

class _CoachStudentModuleScreenState extends State<CoachStudentModuleScreen> {
  int _currentIndex = 0;
