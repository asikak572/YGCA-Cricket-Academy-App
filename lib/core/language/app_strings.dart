...
static String get trackCoachSalaryPayments => text(
  "Track paid and pending coach salary payments.",
  "செலுத்தப்பட்ட மற்றும் நிலுவையில் உள்ள பயிற்சியாளர் சம்பளங்களை கண்காணிக்கவும்.",
  "भुगतान और लंबित कोच वेतन को ट्रैक करें।",
);
// Add only missing getters inside AppStrings before the final }.

static String get notAvailable => text(
  "N/A",
  "கிடைக்கவில்லை",
  "उपलब्ध नहीं",
);

static String get activeRecords => text(
  "Active records",
  "செயலில் உள்ள பதிவுகள்",
  "सक्रिय रिकॉर्ड",
);

static String get monthlyExpense => text(
  "Monthly Expense",
  "மாதாந்திர செலவு",
  "मासिक खर्च",
);

static String get totalSalary => text(
  "Total salary",
  "மொத்த சம்பளம்",
  "कुल वेतन",
);

static String get highestSalary => text(
  "Highest Salary",
  "அதிகபட்ச சம்பளம்",
  "सबसे अधिक वेतन",
);

static String get averageSalary => text(
  "Average Salary",
  "சராசரி சம்பளம்",
  "औसत वेतन",
);

static String get perCoach => text(
  "Per coach",
  "ஒவ்வொரு பயிற்சியாளருக்கும்",
  "प्रति कोच",
);

static String get coachSalaryRanking => text(
  "Coach Salary Ranking",
  "பயிற்சியாளர் சம்பள தரவரிசை",
  "कोच वेतन रैंकिंग",
);

static String get salaryAnalytics => text(
  "Salary Analytics",
  "சம்பள பகுப்பாய்வு",
  "वेतन विश्लेषण",
);

static String get coachSalaryExpenseOverview => text(
  "Coach salary expense overview",
  "பயிற்சியாளர் சம்பள செலவு சுருக்கம்",
  "कोच वेतन खर्च का अवलोकन",
);

static String get expense => text(
  "Expense",
  "செலவு",
  "खर्च",
);

static String get highest => text(
  "Highest",
  "அதிகபட்சம்",
  "सबसे अधिक",
);

static String get averageShort => text(
  "Avg",
  "சராசரி",
  "औसत",
);

static String get topPaidCoach => text(
  "Top Paid Coach",
  "அதிக சம்பளம் பெறும் பயிற்சியாளர்",
  "सबसे अधिक वेतन पाने वाला कोच",
);

static String get coachSalaryRecordsWillAppearHere => text(
  "Coach salary records will appear here",
  "பயிற்சியாளர் சம்பள பதிவுகள் இங்கே காணப்படும்",
  "कोच वेतन रिकॉर्ड यहाँ दिखाई देंगे",
);
static String get totalCoaches => text(
  "Total Coaches",
  "மொத்த பயிற்சியாளர்கள்",
  "कुल कोच",
);
static String get coaches => text(
  "Coaches",
  "பயிற்சியாளர்கள்",
  "कोच",
);
static String get salaryReports => text("Salary Reports","சம்பள அறிக்கைகள்","वेतन रिपोर्ट");
static String get overallCoachSalaryAnalytics => text("Overall coach salary analytics","மொத்த பயிற்சியாளர் சம்பள பகுப்பாய்வு","समग्र कोच वेतन विश्लेषण");
static String get yourSalaryReportSummary => text("Your salary report summary","உங்கள் சம்பள அறிக்கை சுருக்கம்","आपकी वेतन रिपोर्ट का सारांश");
static String get salaryReportCenter => text("Salary Report Center","சம்பள அறிக்கை மையம்","वेतन रिपोर्ट केंद्र");
static String get viewPaidPendingTotalSalaryAnalytics => text("View paid, pending and total salary analytics.","செலுத்தப்பட்ட, நிலுவையில் உள்ள மற்றும் மொத்த சம்பள பகுப்பாய்வைப் பாருங்கள்.","भुगतान, लंबित और कुल वेतन विश्लेषण देखें।");
static String get paidCompletion => text("Paid Completion","செலுத்தல் நிறைவு","भुगतान पूर्णता");
static String get completion => text("Completion","நிறைவு","पूर्णता");
static String get salaryReportSummary => text("Salary Report Summary","சம்பள அறிக்கை சுருக்கம்","वेतन रिपोर्ट सारांश");
static String get recentSalaryRecords => text("Recent Salary Records","சமீபத்திய சம்பள பதிவுகள்","हाल के वेतन रिकॉर्ड");
static String get totalSalaryAmount => text("Total Salary Amount","மொத்த சம்பள தொகை","कुल वेतन राशि");
static String get paidSalaryAmount => text("Paid Salary Amount","செலுத்தப்பட்ட சம்பள தொகை","भुगतान की गई वेतन राशि");
static String get pendingSalaryAmount => text("Pending Salary Amount","நிலுவையில் உள்ள சம்பள தொகை","लंबित वेतन राशि");
static String get totalSalaryRecords => text("Total Salary Records","மொத்த சம்பள பதிவுகள்","कुल वेतन रिकॉर्ड");
static String get paidPendingCount => text("Paid / Pending Count","செலுத்தப்பட்டது / நிலுவை எண்ணிக்கை","भुगतान / लंबित संख्या");
static String get noSalaryReportsFound => text("No Salary Reports Found","சம்பள அறிக்கைகள் இல்லை","कोई वेतन रिपोर्ट नहीं मिली");
static String get noSalaryRecordsToGenerateReports => text("No salary records are available to generate reports.","அறிக்கைகளை உருவாக்க சம்பள பதிவுகள் இல்லை.","रिपोर्ट बनाने के लिए कोई वेतन रिकॉर्ड उपलब्ध नहीं है।");
static String get coachModuleTitle => text(
  "Coach Module",
  "பயிற்சியாளர் தொகுதி",
  "कोच मॉड्यूल",
);

static String get coachModuleCoachManagement => text(
  "Coach Management",
  "பயிற்சியாளர் மேலாண்மை",
  "कोच प्रबंधन",
);

static String get coachModuleCoachSalary => text(
  "Coach Salary",
  "பயிற்சியாளர் சம்பளம்",
  "कोच वेतन",
);

static String get coachModuleManageCoachRecords => text(
  "Manage coach records, details and status",
  "பயிற்சியாளர் பதிவுகள், விவரங்கள் மற்றும் நிலையை நிர்வகிக்கவும்",
  "कोच रिकॉर्ड, विवरण और स्थिति प्रबंधित करें",
);

static String get coachModuleViewAssignedStudents => text(
  "View assigned students, attendance and performance",
  "ஒதுக்கப்பட்ட மாணவர்கள், வருகை மற்றும் செயல்திறனைப் பாருங்கள்",
  "असाइन किए गए छात्रों, उपस्थिति और प्रदर्शन को देखें",
);

static String get coachModuleViewSalaryRecords => text(
  "View salary records, payments and reports",
  "சம்பள பதிவுகள், கட்டணங்கள் மற்றும் அறிக்கைகளைப் பாருங்கள்",
  "वेतन रिकॉर्ड, भुगतान और रिपोर्ट देखें",
);

static String get coachModuleAddManageCoaches => text(
  "Add / Manage Coaches",
  "பயிற்சியாளர்களை சேர் / நிர்வகி",
  "कोच जोड़ें / प्रबंधित करें",
);

static String get coachModuleAddManageCoachesSubtitle => text(
  "Add new coach, edit, delete and manage coach records",
  "புதிய பயிற்சியாளரை சேர்த்து, திருத்தி, நீக்கி பதிவுகளை நிர்வகிக்கவும்",
  "नया कोच जोड़ें, संपादित करें, हटाएं और रिकॉर्ड प्रबंधित करें",
);

static String get coachModuleAssignWeeklyTrainingSessions => text(
  "Assign coaches to weekly training sessions",
  "வாராந்திர பயிற்சி அமர்வுகளுக்கு பயிற்சியாளர்களை ஒதுக்கவும்",
  "साप्ताहिक प्रशिक्षण सेशन के लिए कोच असाइन करें",
);

static String get coachModuleViewCoachProfileDetails => text(
  "View full profile details of each coach",
  "ஒவ்வொரு பயிற்சியாளரின் முழு சுயவிவர விவரங்களையும் பாருங்கள்",
  "प्रत्येक कोच का पूरा प्रोफ़ाइल विवरण देखें",
);

static String get coachModuleManageCoachStatus => text(
  "Manage active, inactive and pending coach status",
  "செயலில், செயலற்ற மற்றும் நிலுவையில் உள்ள பயிற்சியாளர் நிலையை நிர்வகிக்கவும்",
  "सक्रिय, निष्क्रिय और लंबित कोच स्थिति प्रबंधित करें",
);

static String get coachModuleViewStudentsByBatch => text(
  "View Students by Batch",
  "பேட்ச் அடிப்படையில் மாணவர்களைப் பாருங்கள்",
  "बैच के अनुसार छात्रों को देखें",
);

static String get coachModuleSeeAssignedStudentsBatchWise => text(
  "See assigned students batch wise",
  "ஒதுக்கப்பட்ட மாணவர்களை பேட்ச் வாரியாகப் பாருங்கள்",
  "असाइन किए गए छात्रों को बैच अनुसार देखें",
);

static String get coachModuleViewAttendanceSummary => text(
  "View attendance summary of assigned students",
  "ஒதுக்கப்பட்ட மாணவர்களின் வருகை சுருக்கத்தைப் பாருங்கள்",
  "असाइन किए गए छात्रों की उपस्थिति का सारांश देखें",
);

static String get coachModuleCheckPerformanceProgress => text(
  "Check batting, bowling, fielding and fitness progress",
  "பேட்டிங், பந்துவீச்சு, ஃபீல்டிங் மற்றும் உடற்தகுதி முன்னேற்றத்தைச் சரிபார்க்கவும்",
  "बल्लेबाजी, गेंदबाजी, फील्डिंग और फिटनेस प्रगति देखें",
);

static String get coachModuleAddViewMonthlySalary => text(
  "Add salary and view monthly salary records",
  "சம்பளத்தைச் சேர்த்து மாதாந்திர சம்பள பதிவுகளைப் பாருங்கள்",
  "वेतन जोड़ें और मासिक वेतन रिकॉर्ड देखें",
);

static String get coachModuleViewUpdateSalaryStatus => text(
  "View and update paid or pending salary status",
  "செலுத்தப்பட்ட அல்லது நிலுவையில் உள்ள சம்பள நிலையைப் பார்த்து புதுப்பிக்கவும்",
  "भुगतान या लंबित वेतन स्थिति देखें और अपडेट करें",
);

static String get coachModuleViewSalarySummaryAnalytics => text(
  "View salary summary, analytics and report details",
...
static String get digitalIdCardTitle => text(
  "Digital ID Card",
  "டிஜிட்டல் அடையாள அட்டை",
  "डिजिटल पहचान पत्र",
);

static String get youngGenCricketAcademy => text(
  "Young Gen Cricket Academy",
  "யங் ஜென் கிரிக்கெட் அகாடமி",
  "यंग जेन क्रिकेट अकादमी",
);

static String get studentIdCard => text(
  "Student ID Card",
  "மாணவர் அடையாள அட்டை",
  "छात्र पहचान पत्र",
);

static String get disciplinePassionSuccess => text(
  "Discipline • Passion • Success",
  "ஒழுக்கம் • ஆர்வம் • வெற்றி",
  "अनुशासन • जुनून • सफलता",
);

static String get digitalIdValidForVerification => text(
  "This digital ID is valid only for academy verification.",
  "இந்த டிஜிட்டல் அடையாள அட்டை அகாடமி சரிபார்ப்பிற்காக மட்டுமே செல்லுபடியாகும்.",
  "यह डिजिटल पहचान पत्र केवल अकादमी सत्यापन के लिए मान्य है।",
);

static String get useIdCardForVerification => text(
  "Use this ID card for student verification inside the academy.",
  "அகாடமிக்குள் மாணவர் சரிபார்ப்பிற்கு இந்த அடையாள அட்டையை பயன்படுத்தவும்.",
  "अकादमी के भीतर छात्र सत्यापन के लिए इस पहचान पत्र का उपयोग करें।",
);

static String get editProfileTitle => text(
  "Edit Profile",
  "சுயவிவரத்தை திருத்து",
  "प्रोफ़ाइल संपादित करें",
);

static String get editProfileImageTooLarge => text(
  "Image size must be less than 2 MB",
  "படத்தின் அளவு 2 MB-க்கும் குறைவாக இருக்க வேண்டும்",
  "छवि का आकार 2 MB से कम होना चाहिए",
);

static String get editProfilePhotoUploaded => text(
  "Profile photo uploaded successfully",
  "சுயவிவரப் படம் வெற்றிகரமாக பதிவேற்றப்பட்டது",
  "प्रोफ़ाइल फ़ोटो सफलतापूर्वक अपलोड हुई",
);

static String get editProfileNamePhoneRequired => text(
  "Name and phone number are required",
  "பெயரும் தொலைபேசி எண்ணும் அவசியம்",
  "नाम और फ़ोन नंबर आवश्यक हैं",
);

static String get editProfileUpdatedSuccessfully => text(
  "Profile updated successfully",
  "சுயவிவரம் வெற்றிகரமாக புதுப்பிக்கப்பட்டது",
  "प्रोफ़ाइल सफलतापूर्वक अपडेट हुई",
);

static String get editProfileSaveChanges => text(
  "Save Changes",
  "மாற்றங்களை சேமி",
  "बदलाव सहेजें",
);

static String get editProfileUploading => text(
  "Uploading...",
  "பதிவேற்றப்படுகிறது...",
  "अपलोड हो रहा है...",
);

static String get editProfileUserProfile => text(
  "User Profile",
  "பயனர் சுயவிவரம்",
  "उपयोगकर्ता प्रोफ़ाइल",
);

static String get editProfileYgcaMember => text(
  "YGCA Member",
  "YGCA உறுப்பினர்",
  "YGCA सदस्य",
);

static String get editProfileInfoNote => text(
  ...
  "உங்கள் சொந்த சுயவிவர விவரங்களை மட்டும் புதுப்பிக்கலாம். பேட்ச், ரோல் எண், வருகை மற்றும் கட்டணம் போன்ற அகாடமி தரவுகளை நிர்வாகி கட்டுப்படுத்துகிறார்.",
  "आप केवल अपनी प्रोफ़ाइल जानकारी अपडेट कर सकते हैं। बैच, रोल नंबर, उपस्थिति और फीस जैसे अकादमी डेटा को एडमिन नियंत्रित करता है।",
);
static String get feePaymentTitle => text(
  "Fee Payment",
  "கட்டண செலுத்தல்",
  "फीस भुगतान",
);

static String get upiPayment => text(
  "UPI Payment",
  "UPI கட்டணம்",
  "UPI भुगतान",
);

static String get cashPayment => text(
  "Cash Payment",
  "பண கட்டணம்",
  "नकद भुगतान",
);

static String get bankTransfer => text(
  "Bank Transfer",
  "வங்கி பரிமாற்றம்",
  "बैंक ट्रांसफर",
);

static String get paymentRecordedSuccessfully => text(
  "Payment recorded successfully",
  "கட்டணம் வெற்றிகரமாக பதிவு செய்யப்பட்டது",
  "भुगतान सफलतापूर्वक दर्ज किया गया",
);

static String get payNow => text(
  "Pay Now",
  "இப்போது செலுத்து",
  "अभी भुगतान करें",
);
static String get homeWhatWeOffer => text(
  "What We Offer",
  "நாங்கள் வழங்குவது",
  "हम क्या प्रदान करते हैं",
);

static String get homePractice => text(
  "Practice",
  "பயிற்சி",
  "अभ्यास",
);

static String get homeVideo => text(
  "Video",
  "வீடியோ",
  "वीडियो",
);

static String get homeProfile => text(
  "Profile",
  "சுயவிவரம்",
  "प्रोफ़ाइल",
);

static String get homeYoungGen => text(
  "Young Gen",
  "யங் ஜென்",
  "यंग जेन",
);

static String get homeCricketAcademy => text(
  "Cricket Academy",
  "கிரிக்கெட் அகாடமி",
  "क्रिकेट अकादमी",
);

static String get homeBuildCricketCareer => text(
  "Build your Cricket Career with us",
  "உங்கள் கிரிக்கெட் வாழ்க்கையை எங்களுடன் உருவாக்குங்கள்",
  "अपना क्रिकेट करियर हमारे साथ बनाएं",
);

static String get homeLocation => text(
  "Valasaravakkam, Chennai",
  "வளசரவாக்கம், சென்னை",
  "वलसरवक्कम, चेन्नई",
);

static String get homeLoginToContinue => text(
  "Login to Continue",
  "தொடர உள்நுழைக",
  "जारी रखने के लिए लॉगिन करें",
);

static String get homeContactAcademy => text(
  "Contact Academy for admission and session details",
  "சேர்க்கை மற்றும் அமர்வு விவரங்களுக்கு அகாடமியை தொடர்புகொள்ளவும்",
  "प्रवेश और सेशन विवरण के लिए अकादमी से संपर्क करें",
);

static String get homePassionDisciplineSuccess => text(
  "❤️ Passion  •  ★ Discipline  •  🏆 Success",
  "❤️ ஆர்வம்  •  ★ ஒழுக்கம்  •  🏆 வெற்றி",
  "❤️ जुनून  •  ★ अनुशासन  •  🏆 सफलता",
);
static String get idCardActivePlayer => text(
  "Active Player",
  "செயலில் உள்ள வீரர்",
  "सक्रिय खिलाड़ी",
);

static String get idCardDisciplineTrainingExcellence => text(
  "Discipline • Training • Excellence",
  "ஒழுக்கம் • பயிற்சி • சிறப்பு",
  "अनुशासन • प्रशिक्षण • उत्कृष्टता",
);

static String get idCardIdLabel => text(
  "ID",
  "ஐடி",
  "आईडी",
);

static String get idCardMorningBatch => text(
  "Morning Batch",
  "காலை பேட்ச்",
  "सुबह बैच",
);

static String get idCardScanForVerification => text(
  "Scan for student verification",
  "மாணவர் சரிபார்ப்பிற்காக ஸ்கேன் செய்யவும்",
  "छात्र सत्यापन के लिए स्कैन करें",
);

static String get idCardStudentSignature => text(
  "Student Signature",
  "மாணவர் கையொப்பம்",
  "छात्र हस्ताक्षर",
);

static String get idCardAuthorizedSignature => text(
  "Authorized Signature",
  "அங்கீகரிக்கப்பட்ட கையொப்பம்",
  "अधिकृत हस्ताक्षर",
);

static String get idCardSampleLayoutNote => text(
  "This ID card is a sample layout. Later we can connect it with Firestore student data.",
  "இந்த ஐடி கார்டு ஒரு மாதிரி வடிவமைப்பு. பின்னர் இதை Firestore மாணவர் தரவுடன் இணைக்கலாம்.",
  "यह आईडी कार्ड एक नमूना लेआउट है। बाद में इसे Firestore छात्र डेटा से जोड़ा जा सकता है।",
);
static String get loginEnterEmailPassword => text(
  "Please enter email and password",
  "மின்னஞ்சல் மற்றும் கடவுச்சொல்லை உள்ளிடவும்",
  "कृपया ईमेल और पासवर्ड दर्ज करें",
);

static String get loginFailed => text(
  "Login failed",
  "உள்நுழைவு தோல்வியடைந்தது",
  "लॉगिन विफल",
);

static String get loginNoUserFound => text(
  "No user found",
  "பயனர் கிடைக்கவில்லை",
  "कोई उपयोगकर्ता नहीं मिला",
);

static String get loginWrongPassword => text(
  "Wrong password",
  "தவறான கடவுச்சொல்",
  "गलत पासवर्ड",
);

static String get loginInvalidEmail => text(
  "Invalid email",
  "தவறான மின்னஞ்சல்",
  "अमान्य ईमेल",
);

static String get loginInvalidEmailPassword => text(
  "Invalid email or password",
  "தவறான மின்னஞ்சல் அல்லது கடவுச்சொல்",
  "अमान्य ईमेल या पासवर्ड",
);

static String get loginNetworkError => text(
  "Network error. Please check internet",
  "நெட்வொர்க் பிழை. இணைய இணைப்பை சரிபார்க்கவும்",
  "नेटवर्क त्रुटि। कृपया इंटरनेट जांचें",
);

static String get loginError => text(
  "Login error",
  "உள்நுழைவு பிழை",
  "लॉगिन त्रुटि",
);

static String get loginWelcomeBack => text(
  "Welcome Back",
  "மீண்டும் வரவேற்கிறோம்",
  "वापसी पर स्वागत है",
);

static String get loginTitle => text(
  "Login",
  "உள்நுழை",
  "लॉगिन",
);

static String get loginToContinue => text(
  "To Continue",
  "தொடர",
  "जारी रखने के लिए",
);

static String get loginAccountLogin => text(
  "Account Login",
  "கணக்கு உள்நுழைவு",
  "खाता लॉगिन",
);

static String get loginRoles => text(
  "Admin • Coach • Parent • Student",
  "அட்மின் • பயிற்சியாளர் • பெற்றோர் • மாணவர்",
  "एडमिन • कोच • अभिभावक • छात्र",
);

static String get loginEmailAddress => text(
  "Email Address",
  "மின்னஞ்சல் முகவரி",
  "ईमेल पता",
);

static String get loginEnterEmail => text(
  "Enter email",
  "மின்னஞ்சலை உள்ளிடவும்",
  "ईमेल दर्ज करें",
);

static String get loginPassword => text(
  "Password",
  "கடவுச்சொல்",
  "पासवर्ड",
);

static String get loginEnterPassword => text(
  "Enter password",
  "கடவுச்சொல்லை உள்ளிடவும்",
  "पासवर्ड दर्ज करें",
);

static String get loginNewToYgca => text(
  "New to YGCA?",
  "YGCA-க்கு புதியவரா?",
  "YGCA में नए हैं?",
);

static String get loginRegister => text(
  "Register",
  "பதிவு செய்க",
  "रजिस्टर करें",
);

static String get loginPassionDisciplineSuccess => text(
