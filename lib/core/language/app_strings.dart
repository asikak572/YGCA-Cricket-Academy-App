...
static String get studentCenter =>
    text("STUDENT CENTER", "மாணவர் மையம்", "छात्र केंद्र");

static String get approvalStudentManagement => text(
    "Approval & student management",
    "அனுமதி & மாணவர் மேலாண்மை",
    "स्वीकृति और छात्र प्रबंधन");

static String get approval =>
    text("Approval", "அனுமதி", "स्वीकृति");

static String get registered =>
    text("Registered", "பதிவு", "पंजीकृत");

static String get activePlayers =>
    text("Active Players", "செயலில் உள்ள வீரர்கள்", "सक्रिय खिलाड़ी");

static String get approvals =>
    text("Approvals", "அனுமதிகள்", "स्वीकृतियाँ");

static String get average =>
    text("Average", "சராசரி", "औसत");

static String get searchStudent =>
    text("SEARCH STUDENT", "மாணவரை தேடு", "छात्र खोजें");

static String get searchStudentHint => text(
    "Search name, phone, parent, batch, roll no",
    "பெயர், போன், பெற்றோர், பேட்ச், ரோல் எண் தேடு",
    "नाम, फोन, अभिभावक, बैच, रोल नंबर खोजें");

static String get pendingApproval =>
    text("PENDING APPROVAL", "நிலுவை அனுமதி", "लंबित स्वीकृति");

static String get noPendingApprovals =>
    text("No Pending Approvals", "நிலுவை அனுமதிகள் இல்லை", "कोई लंबित स्वीकृति नहीं");

static String get newStudentsAppearForApproval => text(
    "Newly registered students will appear here for approval.",
    "புதியதாக பதிவு செய்யப்பட்ட மாணவர்கள் அனுமதிக்காக இங்கே தோன்றுவர்.",
    "नए पंजीकृत छात्र स्वीकृति के लिए यहाँ दिखाई देंगे।");

static String get approvedStudents =>
    text("APPROVED STUDENTS", "அங்கீகரிக்கப்பட்ட மாணவர்கள்", "स्वीकृत छात्र");

static String get noApprovedStudentsFound =>
    text("No Approved Students Found", "அங்கீகரிக்கப்பட்ட மாணவர்கள் இல்லை", "कोई स्वीकृत छात्र नहीं मिला");

static String get approvedStudentsAppearHere => text(
    "Approved students will appear here after assigning batch and roll number.",
    "பேட்ச் மற்றும் ரோல் எண் ஒதுக்கிய பிறகு அங்கீகரிக்கப்பட்ட மாணவர்கள் இங்கே தோன்றுவர்.",
    "बैच और रोल नंबर असाइन करने के बाद स्वीकृत छात्र यहाँ दिखाई देंगे।");

static String get addStudent =>
    text("Add Student", "மாணவரை சேர்", "छात्र जोड़ें");

static String get somethingWentWrong =>
    text("Something went wrong", "ஏதோ தவறு ஏற்பட்டது", "कुछ गलत हुआ");

static String get approveStudent =>
    text("Approve Student", "மாணவரை அங்கீகரி", "छात्र स्वीकृत करें");

static String get studentName =>
    text("Student Name", "மாணவர் பெயர்", "छात्र का नाम");

static String get noName =>
    text("No Name", "பெயர் இல்லை", "कोई नाम नहीं");

static String get parent =>
    text("Parent", "பெற்றோர்", "अभिभावक");

static String get notAdded =>
    text("Not Added", "சேர்க்கப்படவில்லை", "जोड़ा नहीं गया");

static String get parentEmail =>
    text("Parent Email", "பெற்றோர் மின்னஞ்சல்", "अभिभावक ईमेल");

static String get phone =>
    text("Phone", "தொலைபேசி", "फोन");

static String get rollNoAutoGenerated => text(
    "Roll No will be generated automatically after approval",
    "அனுமதித்த பிறகு ரோல் எண் தானாக உருவாகும்",
    "स्वीकृति के बाद रोल नंबर अपने आप बनेगा");

static String get sessionBatch =>
    text("Session Batch", "அமர்வு பேட்ச்", "सेशन बैच");

static String get studentApprovedParentLinked => text(
    "Student approved and parent linked if parent account exists",
    "மாணவர் அங்கீகரிக்கப்பட்டார்; பெற்றோர் கணக்கு இருந்தால் இணைக்கப்பட்டது",
    "छात्र स्वीकृत हुआ और अभिभावक खाता मौजूद होने पर लिंक हुआ");

static String get approvalFailed =>
    text("Approval failed", "அனுமதி தோல்வியடைந்தது", "स्वीकृति विफल");

static String get saving =>
    text("Saving...", "சேமிக்கிறது...", "सहेजा जा रहा है...");

static String get approve =>
    text("Approve", "அங்கீகரி", "स्वीकृत करें");

static String get rejectStudentQuestion =>
    text("Reject Student?", "மாணவரை நிராகரிக்கவா?", "छात्र अस्वीकार करें?");

static String get rejectStudentMessage => text(
    "This student will be marked as rejected and will not appear in the active student list.",
    "இந்த மாணவர் நிராகரிக்கப்பட்டவராக குறிக்கப்படுவார் மற்றும் செயலில் உள்ள மாணவர் பட்டியலில் தோன்ற மாட்டார்.",
    "यह छात्र अस्वीकृत चिह्नित होगा और सक्रिय छात्र सूची में दिखाई नहीं देगा।");

static String get reject =>
    text("Reject", "நிராகரி", "अस्वीकार");

static String get rejected =>
    text("Rejected", "நிராகரிக்கப்பட்டது", "अस्वीकृत");

static String get studentRejected =>
    text("Student rejected", "மாணவர் நிராகரிக்கப்பட்டார்", "छात्र अस्वीकृत");

static String get rejectFailed =>
    text("Reject failed", "நிராகரிப்பு தோல்வியடைந்தது", "अस्वीकार विफल");

static String get recently =>
    text("Recently", "சமீபத்தில்", "हाल ही में");
...
static String get attendanceHistory =>
    text("Attendance History", "வருகை வரலாறு", "उपस्थिति इतिहास");

static String get viewAttendanceSummaryAnalytics =>
    text("View attendance summary and analytics", "வருகை சுருக்கம் மற்றும் பகுப்பாய்வைப் பாருங்கள்", "उपस्थिति सारांश और विश्लेषण देखें");

static String get cancel =>
    text("Cancel", "ரத்து", "रद्द");
}